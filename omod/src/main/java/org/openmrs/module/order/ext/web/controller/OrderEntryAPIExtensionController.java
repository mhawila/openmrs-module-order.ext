 ...
 */
package org.openmrs.module.order.ext.web.controller;
 ...
 */
@Controller("${rootrootArtifactid}.OrderEntryAPIExtensionController")
@RequestMapping(value = "module/${rootArtifactid}/${rootArtifactid}.form")
public class OrderEntryAPIExtensionController {
